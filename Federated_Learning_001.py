...
def model_fn():
    keras_model1 = tf.keras.models.Sequential([tf.keras.layers.LSTM(128, return_sequences=True, input_dim=look_back),
                                               tf.keras.layers.LSTM(128, return_sequences=True),
                                               tf.keras.layers.LSTM(128, return_sequences=True),
                                               tf.keras.layers.LSTM(128, return_sequences=True),
                                               tf.keras.layers.LSTM(128),
...
def model_fn2():
    keras_model2 = tf.keras.models.Sequential([tf.keras.layers.LSTM(128, return_sequences=True, input_dim=look_back),
                                               tf.keras.layers.LSTM(128, return_sequences=True),
                                               tf.keras.layers.LSTM(128, return_sequences=True),
                                               tf.keras.layers.LSTM(128, return_sequences=True),
                                               tf.keras.layers.LSTM(128),
...
plt.plot(testPredictPlot2[:240], linewidth=2.0,  label='Predicted network traffic')
plt.show()
